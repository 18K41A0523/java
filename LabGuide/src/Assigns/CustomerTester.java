package Assigns;
	...
	public class CustomerTester {
		...
		* console and saves the data in the file using the methods of

		CustomerFileDB class
		...
		*/
		...
		//displaying the success message System.out.println("Your details are saved"); ReadData.acceptString(); System.out.println("\n\n\n\n\n\n\n");
